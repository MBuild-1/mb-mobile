...
class FavoriteProductBrandController extends BaseGetxController {
  ...
  Future<LoadDataResult<PagingDataResult<FavoriteProductBrand>>> getFavoriteProductBrandPaging(FavoriteProductBrandPagingParameter favoriteProductBrandPagingParameter) {
