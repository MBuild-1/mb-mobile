    ...
    return DioHttpClientProcessing((cancelToken) async {
      dynamic formData = FormData.fromMap(
        <String, dynamic>{
          ...
          if (editUserParameter.username.isNotEmptyString) "username": editUserParameter.username,
          if (editUserParameter.biography.isNotEmptyString) "biography": editUserParameter.biography,
          if (editUserParameter.countryId.isNotEmptyString) "country_id": editUserParameter.countryId,
