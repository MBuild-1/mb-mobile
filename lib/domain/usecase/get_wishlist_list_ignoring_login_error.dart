...
class GetWishlistListIgnoringLoginErrorUseCase {
  final ProductRepository productRepository;

  const GetWishlistListIgnoringLoginErrorUseCase({
    required this.productRepository
  });

  FutureProcessing<LoadDataResult<List<Wishlist>>> execute(WishlistListParameter wishlistListParameter) {
    return productRepository.wishlistListIgnoringLoginError(wishlistListParameter);
  }
}