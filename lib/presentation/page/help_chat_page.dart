...
import 'package:masterbagasi/misc/constant.dart';
import 'package:masterbagasi/misc/dialog_helper.dart';
...
import 'package:masterbagasi/presentation/widget/button/custombutton/sized_outline_gradient_button.dart';
import 'package:masterbagasi/presentation/widget/modified_paged_list_view.dart';
import 'package:masterbagasi/presentation/widget/modified_svg_picture.dart';
...
class HelpChatPage extends RestorableGetxPage<_HelpChatPageRestoration> {
  ...
  HelpChatPage({Key? key}) : super(key: key, pageRestorationId: () => "help-page");
...
mixin HelpChatPageRestorationMixin on MixableGetxPageRestoration {
  ...
  void initState() {
    super.initState();
    helpChatPageRestorableRouteFuture = HelpChatPageRestorableRouteFuture(restorationId: restorationIdWithPageName('help-route'));
  }
