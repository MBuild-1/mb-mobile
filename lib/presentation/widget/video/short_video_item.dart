...
class _ShortVideoPlayerState extends State<_ShortVideoPlayer> {
  ...
  @override
  Widget build(BuildContext context) {
    String baseUrl = "https://www.youtube.com/shorts/${widget.shortVideo.url}";
    return IndexedStack(
